# tune_4p.jl — Tune the flight path controller (FPC) parameters for a four-point kite
# model (KPS4) using the NOMAD black-box optimizer. Runs repeated simulations with
