...
wcs::WCSettings = WCSettings(dt = 1/set.sample_freq); update(wcs); wcs.dt = 1/set.sample_freq
...
function init_globals()
    ...
    kcu   = KCU(se())
    kps4 = KPS4(kcu)
    wcs = WCSettings(dt = 1/set.sample_freq); update(wcs); wcs.dt = 1/set.sample_freq
